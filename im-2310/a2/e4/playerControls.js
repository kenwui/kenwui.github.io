...
//E.g Spotify features the loop, rewind and fast forward buttons as part of the main suite of functions because thinking in terms of the user, these functions serve the most usefulness to the user
// Loop
...
function loop(){
  ...
  if (videoElement.loop){
    ...
    loopButton.style.backgroundColor = "var(--col-04)";
  } else {
